  ...
  <div class="left-sidebar-pro">
    <nav id="sidebar" class="">
      <div class="sidebar-header">
        <a href="<?= base_url('administrator/Pemilihan') ?>"><img width="200" class="main-logo" src="<?= base_url('assets/admin/img/logo/logo.png') ?>" alt="" /></a>
        <strong><a href="<?= base_url('administrator/Pemilihan') ?>"><img width="200" src="<?= base_url('assets/admin/img/logo/logosn.png') ?>" alt="" /></a></strong>
      </div>
      <div class="left-custom-menu-adp-wrap comment-scrollbar">
        <nav class="sidebar-nav left-sidebar-menu-pro">
          <ul class="metismenu" id="menu1">
            <li>
              <a href="<?= base_url('administrator/Pemilihan') ?>" aria-expanded="false"><span class="fa fa-list" aria-hidden="true"></span> <span class="mini-click-non">Pemilihan</span></a>
            </li>
            <li>
              <a href="<?= base_url('administrator/Jabatan') ?>" aria-expanded="false"><span class="fa fa-users" aria-hidden="true"></span> <span class="mini-click-non">Jabatan</span></a>
            </li>
            <li>
              <a href="<?= base_url('administrator/Berita') ?>" aria-expanded="false"><span class="fa fa-file" aria-hidden="true"></span> <span class="mini-click-non">Berita</span></a>
            </li>
            <li>
              <a href="<?= base_url('administrator/Dpt') ?>" aria-expanded="false"><span class="fa fa-users" aria-hidden="true"></span> <span class="mini-click-non">DPT</span></a>
            </li>
            <li>
              <a href="<?= base_url('administrator/Admin') ?>" aria-expanded="false"><span class="fa fa-users" aria-hidden="true"></span> <span class="mini-click-non">Admin</span></a>
            </li>
            <li>
              <a href="<?= base_url('Admin/logout') ?>" aria-expanded="false"><span class="fa fa-sign-out" aria-hidden="true"></span> <span class="mini-click-non">Logout</span></a>
            </li>
          </ul>
        </nav>
      </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="logo-pro">
            <a href="<?= base_url('administrator/Dashboard') ?>"><img width="200" class="main-logo" src="<?= base_url('assets/admin/img/logo/logo.png') ?>" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="mobile-menu">
                <nav id="dropdown">
                  <ul class="mobile-menu-nav">
                    <li><a href="<?= base_url('administrator/Pemilihan') ?>">Pemilihan</a></li>
                    <li><a href="<?= base_url('administrator/Jabatan') ?>">Jabatan</a></li>
                    <li><a href="<?= base_url('administrator/Berita') ?>">Berita</a></li>
                    <li><a href="<?= base_url('administrator/Dpt') ?>">DPT</a></li>
                    <li><a href="<?= base_url('administrator/Admin') ?>">Admin</a></li>
