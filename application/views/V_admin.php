      ...
      $.ajax({
        ...
        success: function(data) {
          if (data == 'success') {
            ...
            $('#alert').html('<div class="alert alert-danger" role="alert">Username / Password Salah!</div>');
          }
        }
      });
    } else {
      $('#alert').html('<div class="alert alert-danger" role="alert">Username / Password Tidak Boleh Kosong!</div>');
    }
  }
